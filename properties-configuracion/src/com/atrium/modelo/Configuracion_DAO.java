...
public class Configuracion_DAO {
	...
	public Configuracion_DTO cargar_Configuracion() {
		...
		try {
			...
			confi_dto.setRuta_bitacora(datos_configuracion
					.getProperty("ruta_bitacora"));
			confi_dto.setRuta_enginebirt(datos_configuracion
					.getProperty("ruta_enginebirt"));
			confi_dto.setRuta_logsbirt(datos_configuracion
					.getProperty("ruta_logsbirt"));
			confi_dto.setRuta_listados(datos_configuracion
					.getProperty("ruta_listados"));
			confi_dto.setRuta_serializacion(datos_configuracion
					.getProperty("ruta_serializacion"));
			confi_dto.setRuta_iconos(datos_configuracion
					.getProperty("ruta_iconos"));
			confi_dto.setIdioma(datos_configuracion.getProperty("idioma"));
			confi_dto.setIdioma_preferido(datos_configuracion
					.getProperty("idioma.preferido"));
			confi_dto.setIdioma_defecto(datos_configuracion
					.getProperty("idioma.defecto"));
			confi_dto.setPermitir_idioma(datos_configuracion
					.getProperty("permitir_idioma"));
			confi_dto.setModo_ejecucion(datos_configuracion
			...
			confi_dto.setVersion(new Float(datos_configuracion
					.getProperty("version")));
			confi_dto.setFecha_actualizacion(new SimpleDateFormat(
					"dd/MMMM/yyyy").parse(datos_configuracion
					.getProperty("fecha_actualizacion")));
		} catch (Exception e) {
	...
	public boolean modificar_Configuracion(Configuracion_DTO confi_dto) {
		...
		try {
			...
			// FICHERO
			datos_configuracion.setProperty("version", confi_dto.getVersion()
					.toString());
			...
			datos_configuracion.setProperty("ruta_seguridad",
					confi_dto.getRuta_seguridad());
			datos_configuracion.setProperty("ruta_bitacora",
					confi_dto.getRuta_iconos());
			datos_configuracion.setProperty("ruta_enginebirt",
					confi_dto.getRuta_enginebirt());
			datos_configuracion.setProperty("ruta_logsbirt",
					confi_dto.getRuta_logsbirt());
			datos_configuracion.setProperty("ruta_listados",
					confi_dto.getRuta_listados());
			datos_configuracion.setProperty("ruta_serializacion",
					confi_dto.getRuta_serializacion());
			datos_configuracion.setProperty("ruta_iconos",
					confi_dto.getRuta_iconos());
			datos_configuracion.setProperty("idioma", confi_dto.getIdioma());
			datos_configuracion.setProperty("idioma.preferido",
					confi_dto.getIdioma_preferido());
			datos_configuracion.setProperty("idioma.defecto",
					confi_dto.getIdioma_defecto());
			datos_configuracion.getProperty("permitir_idioma",
					confi_dto.getPermitir_idioma());
			datos_configuracion.setProperty("modo_ejecucion",
					confi_dto.getModo_ejecucion());
	...
	public boolean establecer_OpcionesDefecto() {
		...
		confi_dto.setRuta_depuracion("d:/directorio_logs/seguimiento/j315/");
		confi_dto.setRuta_seguridad("d:/directorio_logs/seguridad/j315/");
		confi_dto.setRuta_bitacora("d:/otros-logs/j315/");
		confi_dto.setRuta_enginebirt("D:/j315/birt-runtime-3_7_2/ReportEngine");
		confi_dto.setRuta_logsbirt("d:/otros_logs/logs-j315/");
		confi_dto.setRuta_listados("d:/informes/j315/");
		confi_dto.setRuta_serializacion("d:/informes/j315/serializar");
