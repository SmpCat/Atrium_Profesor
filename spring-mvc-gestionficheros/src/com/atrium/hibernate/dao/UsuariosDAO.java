...
public class UsuariosDAO {
	...
	public Usuarios findById(java.lang.String id) {
		...
		try {
			Usuarios instance = (Usuarios) getCurrentSession().get("com.atrium.hibernate.Usuarios", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Usuarios> findByExample(Usuarios instance) {
		...
		try {
			List<Usuarios> results = (List<Usuarios>) getCurrentSession()
					.createCriteria("com.atrium.hibernate.Usuarios").add(create(instance)).list();
